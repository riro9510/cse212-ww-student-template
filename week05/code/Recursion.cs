...
public static class Recursion
{
    ...
    for (int i = 0; i < letters.Length; i++)
    {
        ...
        PermutationsChoose(results, letters.Substring(0, i) + letters.Substring(i + 1), size, word + currentLetter);
    }
    }
    ...
    var suffix = pattern.Substring(index + 1);
